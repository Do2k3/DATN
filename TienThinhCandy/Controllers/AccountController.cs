    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                TienThinhCandy.Common.Common.SendMail("Tiến Thịnh - Một thoáng kinh kỳ", "Quên mật khẩu", "Bạn vui lòng kích vào <a href='" + callbackUrl + "'>đây</a> để đặt lại mật khẩu", model.Email);
